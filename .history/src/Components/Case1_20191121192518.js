        ...
        return (
            ...
            <div className="grid-container-x">
                ...
                <img className="xbig-img" src={cover} alt="Cover photo" />
                    ...
                    <p className="case-important" ><b>Using a well-known social media app, extend or redesign a feature that helps encourage specific types of people in one’s surrounding area to get to gether in-person and physically interact in a meaningful way.</b></p>
