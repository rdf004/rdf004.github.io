...
We’re empowering users to do just that. Introducing, Events Check-In: a new LinkedIn feature to bring you closer to your connections during shared experiences, such as professional conferences and networking events.</p>
                    ...
                    <p>- Empower them to engage with friends and connections, thus rekindling old bonds and enforcing existing ones through shared experience</p><br/>
                    <p>- Interact with new people at the event. Discover and make new connections with similar goals for the event, thus further enriching the event experience.</p><br/>
