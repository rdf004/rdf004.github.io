        ...
        return (
            ...
            <div className="grid-container-x">
                ...
                <img className="xbig-img" src={cover} alt="Cover photo" />
                    ...
                    <p>My teammates Edward and Prabhav and I collaborated on all work. Each of us had a hand in design, user interviews, and writing. However, I focused more on writing and on the Figma LinkedIn app high-fidelity prototypes. I was also responsible for all paper prototypes and summarizing design testing feedback.</p>
                    <h2>The Problem</h2>
