        ...
        return (
            ...
            <div className="grid-container-x">
                ...
                <img className="xbig-img" src={cover} alt="Cover photo" />
                    ...
                    <h2>The Problem</h2>
                    <h3 className="case-important" ><b>Design Prompt</b></h3>
                    <p className="case-important" ><b><b>Using a well-known social media app, extend or redesign a feature that helps encourage specific types of people in one’s surrounding area to get to gether in-person and physically interact in a meaningful way.</b></b></p>
